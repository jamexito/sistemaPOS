                ...
                <div class="box">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" id="vendedorN" value="<?php echo $_SESSION["nombre"]; ?>" readonly>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      if (!$ventas) {
                        ...
                        echo '<input type="text" class="form-control" id="ventaN" name="ventaN" value="100001" readonly>';
                        ...
                        echo '<input type="text" class="form-control" id="ventaN" name="ventaN" value="'.$codigo.'" readonly>';
